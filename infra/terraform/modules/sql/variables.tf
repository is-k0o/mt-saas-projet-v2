...
variable "sql_admin_password" {
  description = "SQL admin password (sensitive). Provide via TF_VAR_sql_admin_password or a GitHub secret."
  type        = string
  sensitive   = true
}
...
variable "aad_admin_tenant_id" {
  description = "Optional: Tenant ID for the Azure AD admin."
  type        = string
  default     = null
}
